...
Update on 2026-06-13: this preliminary snapshot now has a rerunnable replacement at `paper/notes/2026-06-13-human-translation-length-bias-reproducible.md`, generated by `analyze_verified_translation_length_bias.py` with a row-level audit CSV at `paper/notes/2026-06-13-human-translation-length-bias-rows.csv`.
