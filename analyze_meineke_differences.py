#!/usr/bin/env python3
"""
Analyze Meineke/Billerbeck Greek differences with GPT-5.6 Luna function calling.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyze Meineke/Billerbeck differences with GPT-5.6 Luna")
