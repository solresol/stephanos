...
CREATE FUNCTION public.validate_scholarly_analysis_snapshot() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: validate_scholarly_apparatus_reference(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_scholarly_apparatus_reference() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: validate_scholarly_source_line_reference(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_scholarly_source_line_reference() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    expected_source_id integer;
...
--
-- Name: validate_scholarly_translation_request_reference(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_scholarly_translation_request_reference() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: validate_scholarly_witness_source(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_scholarly_witness_source() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: scholarly_analysis_snapshots; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_analysis_snapshots (
    ...
    CONSTRAINT scholarly_analysis_snapshots_sha256_check CHECK ((input_sha256 ~ '^[0-9a-f]{64}$'::text))
);


--
-- Name: scholarly_analysis_snapshots_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_analysis_snapshots_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_analysis_snapshots_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_analysis_snapshots_id_seq OWNED BY public.scholarly_analysis_snapshots.id;


--
-- Name: scholarly_confidence_levels; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_entries; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_entries (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT scholarly_entries_key_check CHECK ((btrim(entry_key) <> ''::text)),
    CONSTRAINT scholarly_entries_order_check CHECK ((publication_order > 0))
);


--
-- Name: scholarly_entries_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_entries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_entries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_entries_id_seq OWNED BY public.scholarly_entries.id;


--
-- Name: scholarly_entry_witness_source_versions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE scholarly_entry_witness_source_versions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.scholarly_entry_witness_source_versions IS 'Copyright-safe source boundary for scholarly automation. Only public Meineke or Kiesling Greek text versions are accepted by trigger.';


--
-- Name: scholarly_entry_witness_source_versions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_entry_witness_source_versions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_entry_witness_source_versions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_entry_witness_source_versions_id_seq OWNED BY public.scholarly_entry_witness_source_versions.id;


--
-- Name: scholarly_entry_witnesses; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_entry_witnesses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_entry_witnesses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_entry_witnesses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_entry_witnesses_id_seq OWNED BY public.scholarly_entry_witnesses.id;


--
-- Name: scholarly_finding_apparatus_entries; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_citation_mentions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_guidance_matches; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_place_clusters; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_proper_nouns; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_quote_passages; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_relations; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_finding_relations (
    ...
    CONSTRAINT scholarly_finding_relations_not_self_check CHECK ((finding_id <> related_finding_id))
);


--
-- Name: scholarly_finding_source_lines; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_finding_source_lines (
    ...
    anchor_start integer,
    anchor_end integer,
    CONSTRAINT scholarly_finding_source_lines_offsets_check CHECK ((((anchor_start IS NULL) AND (anchor_end IS NULL)) OR ((anchor_start IS NOT NULL) AND (anchor_end IS NOT NULL) AND (anchor_start >= 0) AND (anchor_end > anchor_start))))
);


--
-- Name: scholarly_finding_translation_segments; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_finding_translation_segments (
    ...
    anchor_start integer,
    anchor_end integer,
    CONSTRAINT scholarly_finding_translation_segments_offsets_check CHECK ((((anchor_start IS NULL) AND (anchor_end IS NULL)) OR ((anchor_start IS NOT NULL) AND (anchor_end IS NOT NULL) AND (anchor_start >= 0) AND (anchor_end > anchor_start))))
);


--
-- Name: scholarly_finding_types; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_verifications; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_finding_verifications (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT scholarly_finding_verifications_rationale_check CHECK ((btrim(rationale) <> ''::text))
);


--
-- Name: scholarly_finding_verifications_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_finding_verifications_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_finding_verifications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_finding_verifications_id_seq OWNED BY public.scholarly_finding_verifications.id;


--
-- Name: scholarly_finding_word_occurrences; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_findings; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_findings (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT scholarly_findings_statement_check CHECK ((btrim(statement) <> ''::text))
);


--
-- Name: TABLE scholarly_findings; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.scholarly_findings IS 'Relational claim ledger: one atomic specialist assertion per row, with typed subtype and evidence junction rows.';


--
-- Name: scholarly_findings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_findings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_findings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_findings_id_seq OWNED BY public.scholarly_findings.id;


--
-- Name: scholarly_geographic_findings; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_geographic_findings (
    ...
    latitude double precision,
    longitude double precision,
    CONSTRAINT scholarly_geographic_findings_latitude_check CHECK (((latitude IS NULL) OR ((latitude >= ('-90'::integer)::double precision) AND (latitude <= (90)::double precision)))),
    CONSTRAINT scholarly_geographic_findings_longitude_check CHECK (((longitude IS NULL) OR ((longitude >= ('-180'::integer)::double precision) AND (longitude <= (180)::double precision))))
);


--
-- Name: scholarly_job_statuses; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_jobs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_jobs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_jobs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_jobs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_jobs_id_seq OWNED BY public.scholarly_jobs.id;


--
-- Name: scholarly_lexical_findings; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_lexical_findings (
    ...
    CONSTRAINT scholarly_lexical_findings_corpus_count_check CHECK (((corpus_count IS NULL) OR (corpus_count >= 0)))
);


--
-- Name: scholarly_note_findings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_note_translation_segments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_notes; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_notes (
    ...
    CONSTRAINT scholarly_notes_text_check CHECK ((btrim(note_text) <> ''::text))
);


--
-- Name: scholarly_notes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_notes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_notes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_notes_id_seq OWNED BY public.scholarly_notes.id;


--
-- Name: scholarly_rarity_classes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_relation_types; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_revision_statuses; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_run_dependencies; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.scholarly_run_dependencies (
    run_id bigint NOT NULL,
    depends_on_run_id bigint NOT NULL,
    CONSTRAINT scholarly_run_dependencies_not_self_check CHECK ((run_id <> depends_on_run_id))
);


--
-- Name: scholarly_runs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_runs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_runs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_runs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_runs_id_seq OWNED BY public.scholarly_runs.id;


--
-- Name: scholarly_significance_levels; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_skill_definitions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_skill_definitions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_skill_definitions_id_seq
    AS smallint
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: scholarly_skill_definitions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_skill_definitions_id_seq OWNED BY public.scholarly_skill_definitions.id;


--
-- Name: scholarly_skill_versions; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_skill_versions (
    ...
    is_active boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT scholarly_skill_versions_sha256_check CHECK ((instructions_sha256 ~ '^[0-9a-f]{64}$'::text))
);


--
-- Name: scholarly_skill_versions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_skill_versions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_skill_versions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_skill_versions_id_seq OWNED BY public.scholarly_skill_versions.id;


--
-- Name: scholarly_source_findings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_source_roles; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_stephanos_findings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_stephanos_phenomenon_types; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_textual_findings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_findings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_issue_types; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_revision_request_findings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_revision_requests; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_translation_revision_requests (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    completed_at timestamp with time zone,
    CONSTRAINT scholarly_translation_revision_requests_change_check CHECK ((btrim(requested_change) <> ''::text))
);


--
-- Name: scholarly_translation_revision_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_translation_revision_requests_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_translation_revision_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_translation_revision_requests_id_seq OWNED BY public.scholarly_translation_revision_requests.id;


--
-- Name: scholarly_translation_segment_source_lines; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_translation_segment_source_lines (
    ...
    CONSTRAINT scholarly_translation_segment_source_lines_order_check CHECK ((alignment_order > 0))
);


--
-- Name: scholarly_translation_segments; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.scholarly_translation_segments (
    ...
    CONSTRAINT scholarly_translation_segments_sha256_check CHECK ((text_sha256 ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT scholarly_translation_segments_text_check CHECK ((btrim(segment_text) <> ''::text))
);


--
-- Name: scholarly_translation_segments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_translation_segments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_translation_segments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_translation_segments_id_seq OWNED BY public.scholarly_translation_segments.id;


--
-- Name: scholarly_verdict_types; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_verification_runs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_verification_runs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scholarly_verification_runs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scholarly_verification_runs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scholarly_verification_runs_id_seq OWNED BY public.scholarly_verification_runs.id;


--
-- Name: scholarly_witness_roles; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scholarly_analysis_snapshots id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_analysis_snapshots ALTER COLUMN id SET DEFAULT nextval('public.scholarly_analysis_snapshots_id_seq'::regclass);


--
-- Name: scholarly_entries id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entries ALTER COLUMN id SET DEFAULT nextval('public.scholarly_entries_id_seq'::regclass);


--
-- Name: scholarly_entry_witness_source_versions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witness_source_versions ALTER COLUMN id SET DEFAULT nextval('public.scholarly_entry_witness_source_versions_id_seq'::regclass);


--
-- Name: scholarly_entry_witnesses id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witnesses ALTER COLUMN id SET DEFAULT nextval('public.scholarly_entry_witnesses_id_seq'::regclass);


--
-- Name: scholarly_finding_verifications id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_verifications ALTER COLUMN id SET DEFAULT nextval('public.scholarly_finding_verifications_id_seq'::regclass);


--
-- Name: scholarly_findings id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_findings ALTER COLUMN id SET DEFAULT nextval('public.scholarly_findings_id_seq'::regclass);


--
-- Name: scholarly_jobs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_jobs ALTER COLUMN id SET DEFAULT nextval('public.scholarly_jobs_id_seq'::regclass);


--
-- Name: scholarly_notes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_notes ALTER COLUMN id SET DEFAULT nextval('public.scholarly_notes_id_seq'::regclass);


--
-- Name: scholarly_runs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_runs ALTER COLUMN id SET DEFAULT nextval('public.scholarly_runs_id_seq'::regclass);


--
-- Name: scholarly_skill_definitions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_skill_definitions ALTER COLUMN id SET DEFAULT nextval('public.scholarly_skill_definitions_id_seq'::regclass);


--
-- Name: scholarly_skill_versions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_skill_versions ALTER COLUMN id SET DEFAULT nextval('public.scholarly_skill_versions_id_seq'::regclass);


--
-- Name: scholarly_translation_revision_requests id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_requests ALTER COLUMN id SET DEFAULT nextval('public.scholarly_translation_revision_requests_id_seq'::regclass);


--
-- Name: scholarly_translation_segments id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_segments ALTER COLUMN id SET DEFAULT nextval('public.scholarly_translation_segments_id_seq'::regclass);


--
-- Name: scholarly_verification_runs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_verification_runs ALTER COLUMN id SET DEFAULT nextval('public.scholarly_verification_runs_id_seq'::regclass);
...
--
-- Name: scholarly_analysis_snapshots scholarly_analysis_snapshots_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_analysis_snapshots scholarly_analysis_snapshots_source_run_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_analysis_snapshots
    ADD CONSTRAINT scholarly_analysis_snapshots_source_run_key UNIQUE (witness_source_id, translation_run_id);


--
-- Name: scholarly_confidence_levels scholarly_confidence_levels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_entries scholarly_entries_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_entries scholarly_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_entry_witness_source_versions scholarly_entry_witness_source_versions_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witness_source_versions
    ADD CONSTRAINT scholarly_entry_witness_source_versions_key UNIQUE (witness_id, source_text_version_id, source_role_code);


--
-- Name: scholarly_entry_witness_source_versions scholarly_entry_witness_source_versions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_entry_witnesses scholarly_entry_witnesses_entry_lemma_role_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witnesses
    ADD CONSTRAINT scholarly_entry_witnesses_entry_lemma_role_key UNIQUE (entry_id, lemma_id, witness_role_code);


--
-- Name: scholarly_entry_witnesses scholarly_entry_witnesses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_apparatus_entries scholarly_finding_apparatus_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_apparatus_entries
    ADD CONSTRAINT scholarly_finding_apparatus_entries_pkey PRIMARY KEY (finding_id, apparatus_entry_id);


--
-- Name: scholarly_finding_citation_mentions scholarly_finding_citation_mentions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_citation_mentions
    ADD CONSTRAINT scholarly_finding_citation_mentions_pkey PRIMARY KEY (finding_id, citation_mention_id);


--
-- Name: scholarly_finding_guidance_matches scholarly_finding_guidance_matches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_guidance_matches
    ADD CONSTRAINT scholarly_finding_guidance_matches_pkey PRIMARY KEY (finding_id, guidance_match_id);


--
-- Name: scholarly_finding_place_clusters scholarly_finding_place_clusters_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_place_clusters
    ADD CONSTRAINT scholarly_finding_place_clusters_pkey PRIMARY KEY (finding_id, place_cluster_id);


--
-- Name: scholarly_finding_proper_nouns scholarly_finding_proper_nouns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_proper_nouns
    ADD CONSTRAINT scholarly_finding_proper_nouns_pkey PRIMARY KEY (finding_id, proper_noun_id);


--
-- Name: scholarly_finding_quote_passages scholarly_finding_quote_passages_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_quote_passages
    ADD CONSTRAINT scholarly_finding_quote_passages_pkey PRIMARY KEY (finding_id, quote_passage_id);


--
-- Name: scholarly_finding_relations scholarly_finding_relations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_relations
    ADD CONSTRAINT scholarly_finding_relations_pkey PRIMARY KEY (finding_id, related_finding_id, relation_type_code);


--
-- Name: scholarly_finding_source_lines scholarly_finding_source_lines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_translation_segments scholarly_finding_translation_segments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_translation_segments
    ADD CONSTRAINT scholarly_finding_translation_segments_pkey PRIMARY KEY (finding_id, translation_segment_id);


--
-- Name: scholarly_finding_types scholarly_finding_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_verifications scholarly_finding_verifications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_finding_verifications scholarly_finding_verifications_run_finding_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_verifications
    ADD CONSTRAINT scholarly_finding_verifications_run_finding_key UNIQUE (verification_run_id, finding_id);


--
-- Name: scholarly_finding_word_occurrences scholarly_finding_word_occurrences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_word_occurrences
    ADD CONSTRAINT scholarly_finding_word_occurrences_pkey PRIMARY KEY (finding_id, word_occurrence_id);


--
-- Name: scholarly_findings scholarly_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_geographic_findings scholarly_geographic_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_job_statuses scholarly_job_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_jobs scholarly_jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_jobs scholarly_jobs_snapshot_skill_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_lexical_findings scholarly_lexical_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_note_findings scholarly_note_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_note_translation_segments scholarly_note_translation_segments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_note_translation_segments
    ADD CONSTRAINT scholarly_note_translation_segments_pkey PRIMARY KEY (note_id, translation_segment_id);


--
-- Name: scholarly_notes scholarly_notes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_notes scholarly_notes_snapshot_order_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_rarity_classes scholarly_rarity_classes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_relation_types scholarly_relation_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_revision_statuses scholarly_revision_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_run_dependencies scholarly_run_dependencies_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_runs scholarly_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_significance_levels scholarly_significance_levels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_skill_definitions scholarly_skill_definitions_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_skill_definitions scholarly_skill_definitions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_skill_versions scholarly_skill_versions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_skill_versions scholarly_skill_versions_skill_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_skill_versions
    ADD CONSTRAINT scholarly_skill_versions_skill_hash_key UNIQUE (skill_id, instructions_sha256);


--
-- Name: scholarly_source_findings scholarly_source_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_source_roles scholarly_source_roles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_stephanos_findings scholarly_stephanos_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_stephanos_phenomenon_types scholarly_stephanos_phenomenon_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_textual_findings scholarly_textual_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_findings scholarly_translation_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_issue_types scholarly_translation_issue_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_revision_request_findings scholarly_translation_revision_request_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_request_findings
    ADD CONSTRAINT scholarly_translation_revision_request_findings_pkey PRIMARY KEY (revision_request_id, finding_id);


--
-- Name: scholarly_translation_revision_requests scholarly_translation_revision_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_segment_source_lines scholarly_translation_segment_source_lines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_segment_source_lines
    ADD CONSTRAINT scholarly_translation_segment_source_lines_pkey PRIMARY KEY (translation_segment_id, source_line_id);


--
-- Name: scholarly_translation_segments scholarly_translation_segments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_translation_segments scholarly_translation_segments_snapshot_order_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_segments
    ADD CONSTRAINT scholarly_translation_segments_snapshot_order_key UNIQUE (snapshot_id, segment_order);


--
-- Name: scholarly_verdict_types scholarly_verdict_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_verification_runs scholarly_verification_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_verification_runs scholarly_verification_runs_scholarly_run_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_witness_roles scholarly_witness_roles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scholarly_analysis_snapshots_one_current_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX scholarly_analysis_snapshots_one_current_idx ON public.scholarly_analysis_snapshots USING btree (witness_source_id) WHERE (superseded_at IS NULL);


--
-- Name: scholarly_entries_publication_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scholarly_entries_publication_order_idx ON public.scholarly_entries USING btree (publication_order, id);


--
-- Name: scholarly_entry_witness_sources_one_current_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX scholarly_entry_witness_sources_one_current_idx ON public.scholarly_entry_witness_source_versions USING btree (witness_id, source_role_code) WHERE is_current;


--
-- Name: scholarly_finding_verifications_finding_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scholarly_finding_verifications_finding_idx ON public.scholarly_finding_verifications USING btree (finding_id, created_at DESC);


--
-- Name: scholarly_findings_run_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scholarly_findings_run_idx ON public.scholarly_findings USING btree (run_id, id);


--
-- Name: scholarly_jobs_queue_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scholarly_jobs_queue_idx ON public.scholarly_jobs USING btree (status_code, priority, created_at, id);


--
-- Name: scholarly_revision_requests_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scholarly_revision_requests_status_idx ON public.scholarly_translation_revision_requests USING btree (status_code, created_at, id);


--
-- Name: scholarly_runs_job_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scholarly_runs_job_idx ON public.scholarly_runs USING btree (job_id, started_at DESC, id DESC);


--
-- Name: scholarly_skill_versions_one_active_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX scholarly_skill_versions_one_active_idx ON public.scholarly_skill_versions USING btree (skill_id) WHERE is_active;
...
CREATE TRIGGER scholarly_analysis_snapshot_policy BEFORE INSERT OR UPDATE ON public.scholarly_analysis_snapshots FOR EACH ROW EXECUTE FUNCTION public.validate_scholarly_analysis_snapshot();


--
-- Name: scholarly_finding_apparatus_entries scholarly_finding_apparatus_policy; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER scholarly_finding_apparatus_policy BEFORE INSERT OR UPDATE ON public.scholarly_finding_apparatus_entries FOR EACH ROW EXECUTE FUNCTION public.validate_scholarly_apparatus_reference();


--
-- Name: scholarly_finding_source_lines scholarly_finding_source_line_policy; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER scholarly_finding_source_line_policy BEFORE INSERT OR UPDATE ON public.scholarly_finding_source_lines FOR EACH ROW EXECUTE FUNCTION public.validate_scholarly_source_line_reference();


--
-- Name: scholarly_translation_revision_requests scholarly_translation_request_policy; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER scholarly_translation_request_policy BEFORE INSERT OR UPDATE ON public.scholarly_translation_revision_requests FOR EACH ROW EXECUTE FUNCTION public.validate_scholarly_translation_request_reference();


--
-- Name: scholarly_translation_segment_source_lines scholarly_translation_segment_source_line_policy; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER scholarly_translation_segment_source_line_policy BEFORE INSERT OR UPDATE ON public.scholarly_translation_segment_source_lines FOR EACH ROW EXECUTE FUNCTION public.validate_scholarly_source_line_reference();


--
-- Name: scholarly_entry_witness_source_versions scholarly_witness_source_policy; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER scholarly_witness_source_policy BEFORE INSERT OR UPDATE ON public.scholarly_entry_witness_source_versions FOR EACH ROW EXECUTE FUNCTION public.validate_scholarly_witness_source();
...
--
-- Name: scholarly_analysis_snapshots scholarly_analysis_snapshots_translation_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_analysis_snapshots
    ADD CONSTRAINT scholarly_analysis_snapshots_translation_run_id_fkey FOREIGN KEY (translation_run_id) REFERENCES public.translation_runs(id) ON DELETE RESTRICT;


--
-- Name: scholarly_analysis_snapshots scholarly_analysis_snapshots_witness_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_analysis_snapshots
    ADD CONSTRAINT scholarly_analysis_snapshots_witness_source_id_fkey FOREIGN KEY (witness_source_id) REFERENCES public.scholarly_entry_witness_source_versions(id) ON DELETE CASCADE;


--
-- Name: scholarly_entry_witness_source_versions scholarly_entry_witness_source_versions_role_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witness_source_versions
    ADD CONSTRAINT scholarly_entry_witness_source_versions_role_fkey FOREIGN KEY (source_role_code) REFERENCES public.scholarly_source_roles(code) ON DELETE RESTRICT;


--
-- Name: scholarly_entry_witness_source_versions scholarly_entry_witness_source_versions_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witness_source_versions
    ADD CONSTRAINT scholarly_entry_witness_source_versions_source_id_fkey FOREIGN KEY (source_text_version_id) REFERENCES public.lemma_source_text_versions(id) ON DELETE RESTRICT;


--
-- Name: scholarly_entry_witness_source_versions scholarly_entry_witness_source_versions_witness_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witness_source_versions
    ADD CONSTRAINT scholarly_entry_witness_source_versions_witness_id_fkey FOREIGN KEY (witness_id) REFERENCES public.scholarly_entry_witnesses(id) ON DELETE CASCADE;


--
-- Name: scholarly_entry_witnesses scholarly_entry_witnesses_entry_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witnesses
    ADD CONSTRAINT scholarly_entry_witnesses_entry_id_fkey FOREIGN KEY (entry_id) REFERENCES public.scholarly_entries(id) ON DELETE CASCADE;


--
-- Name: scholarly_entry_witnesses scholarly_entry_witnesses_lemma_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witnesses
    ADD CONSTRAINT scholarly_entry_witnesses_lemma_id_fkey FOREIGN KEY (lemma_id) REFERENCES public.assembled_lemmas(id) ON DELETE RESTRICT;


--
-- Name: scholarly_entry_witnesses scholarly_entry_witnesses_role_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_entry_witnesses
    ADD CONSTRAINT scholarly_entry_witnesses_role_fkey FOREIGN KEY (witness_role_code) REFERENCES public.scholarly_witness_roles(code) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_apparatus_entries scholarly_finding_apparatus_entries_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_apparatus_entries
    ADD CONSTRAINT scholarly_finding_apparatus_entries_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_citation_mentions scholarly_finding_citation_mentions_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_citation_mentions
    ADD CONSTRAINT scholarly_finding_citation_mentions_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_citation_mentions scholarly_finding_citation_mentions_mention_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_citation_mentions
    ADD CONSTRAINT scholarly_finding_citation_mentions_mention_id_fkey FOREIGN KEY (citation_mention_id) REFERENCES public.lemma_source_citation_mentions(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_guidance_matches scholarly_finding_guidance_matches_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_guidance_matches
    ADD CONSTRAINT scholarly_finding_guidance_matches_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_guidance_matches scholarly_finding_guidance_matches_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_guidance_matches
    ADD CONSTRAINT scholarly_finding_guidance_matches_match_id_fkey FOREIGN KEY (guidance_match_id) REFERENCES public.translation_guidance_matches(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_place_clusters scholarly_finding_place_clusters_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_place_clusters
    ADD CONSTRAINT scholarly_finding_place_clusters_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_place_clusters scholarly_finding_place_clusters_place_cluster_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_place_clusters
    ADD CONSTRAINT scholarly_finding_place_clusters_place_cluster_id_fkey FOREIGN KEY (place_cluster_id) REFERENCES public.place_clusters(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_proper_nouns scholarly_finding_proper_nouns_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_proper_nouns
    ADD CONSTRAINT scholarly_finding_proper_nouns_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_proper_nouns scholarly_finding_proper_nouns_proper_noun_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_proper_nouns
    ADD CONSTRAINT scholarly_finding_proper_nouns_proper_noun_id_fkey FOREIGN KEY (proper_noun_id) REFERENCES public.proper_nouns(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_quote_passages scholarly_finding_quote_passages_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_quote_passages
    ADD CONSTRAINT scholarly_finding_quote_passages_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_quote_passages scholarly_finding_quote_passages_passage_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_quote_passages
    ADD CONSTRAINT scholarly_finding_quote_passages_passage_id_fkey FOREIGN KEY (quote_passage_id) REFERENCES public.source_quote_passages(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_relations scholarly_finding_relations_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_relations
    ADD CONSTRAINT scholarly_finding_relations_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_relations scholarly_finding_relations_related_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_relations
    ADD CONSTRAINT scholarly_finding_relations_related_id_fkey FOREIGN KEY (related_finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_relations scholarly_finding_relations_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_relations
    ADD CONSTRAINT scholarly_finding_relations_type_fkey FOREIGN KEY (relation_type_code) REFERENCES public.scholarly_relation_types(code) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_source_lines scholarly_finding_source_lines_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_source_lines
    ADD CONSTRAINT scholarly_finding_source_lines_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_translation_segments scholarly_finding_translation_segments_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_translation_segments
    ADD CONSTRAINT scholarly_finding_translation_segments_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_translation_segments scholarly_finding_translation_segments_segment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_translation_segments
    ADD CONSTRAINT scholarly_finding_translation_segments_segment_id_fkey FOREIGN KEY (translation_segment_id) REFERENCES public.scholarly_translation_segments(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_types scholarly_finding_types_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_types
    ADD CONSTRAINT scholarly_finding_types_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.scholarly_skill_definitions(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_verifications scholarly_finding_verifications_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_verifications
    ADD CONSTRAINT scholarly_finding_verifications_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_verifications scholarly_finding_verifications_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_verifications
    ADD CONSTRAINT scholarly_finding_verifications_run_id_fkey FOREIGN KEY (verification_run_id) REFERENCES public.scholarly_verification_runs(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_verifications scholarly_finding_verifications_verdict_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_verifications
    ADD CONSTRAINT scholarly_finding_verifications_verdict_fkey FOREIGN KEY (verdict_code) REFERENCES public.scholarly_verdict_types(code) ON DELETE RESTRICT;


--
-- Name: scholarly_finding_word_occurrences scholarly_finding_word_occurrences_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_word_occurrences
    ADD CONSTRAINT scholarly_finding_word_occurrences_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_finding_word_occurrences scholarly_finding_word_occurrences_occurrence_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_finding_word_occurrences
    ADD CONSTRAINT scholarly_finding_word_occurrences_occurrence_id_fkey FOREIGN KEY (word_occurrence_id) REFERENCES public.meineke_word_lemma_occurrences(id) ON DELETE RESTRICT;


--
-- Name: scholarly_findings scholarly_findings_confidence_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_findings
    ADD CONSTRAINT scholarly_findings_confidence_fkey FOREIGN KEY (confidence_code) REFERENCES public.scholarly_confidence_levels(code) ON DELETE RESTRICT;


--
-- Name: scholarly_findings scholarly_findings_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_findings
    ADD CONSTRAINT scholarly_findings_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.scholarly_runs(id) ON DELETE CASCADE;


--
-- Name: scholarly_findings scholarly_findings_significance_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_findings
    ADD CONSTRAINT scholarly_findings_significance_fkey FOREIGN KEY (significance_code) REFERENCES public.scholarly_significance_levels(code) ON DELETE RESTRICT;


--
-- Name: scholarly_findings scholarly_findings_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_findings
    ADD CONSTRAINT scholarly_findings_type_fkey FOREIGN KEY (finding_type_code) REFERENCES public.scholarly_finding_types(code) ON DELETE RESTRICT;


--
-- Name: scholarly_geographic_findings scholarly_geographic_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_geographic_findings
    ADD CONSTRAINT scholarly_geographic_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_jobs scholarly_jobs_skill_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_jobs
    ADD CONSTRAINT scholarly_jobs_skill_version_id_fkey FOREIGN KEY (skill_version_id) REFERENCES public.scholarly_skill_versions(id) ON DELETE RESTRICT;


--
-- Name: scholarly_jobs scholarly_jobs_snapshot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_jobs
    ADD CONSTRAINT scholarly_jobs_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES public.scholarly_analysis_snapshots(id) ON DELETE CASCADE;


--
-- Name: scholarly_jobs scholarly_jobs_status_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_jobs
    ADD CONSTRAINT scholarly_jobs_status_code_fkey FOREIGN KEY (status_code) REFERENCES public.scholarly_job_statuses(code) ON DELETE RESTRICT;


--
-- Name: scholarly_lexical_findings scholarly_lexical_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_lexical_findings
    ADD CONSTRAINT scholarly_lexical_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_lexical_findings scholarly_lexical_findings_rarity_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_lexical_findings
    ADD CONSTRAINT scholarly_lexical_findings_rarity_fkey FOREIGN KEY (rarity_class_code) REFERENCES public.scholarly_rarity_classes(code) ON DELETE RESTRICT;


--
-- Name: scholarly_note_findings scholarly_note_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_note_findings
    ADD CONSTRAINT scholarly_note_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE RESTRICT;


--
-- Name: scholarly_note_findings scholarly_note_findings_note_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_note_findings
    ADD CONSTRAINT scholarly_note_findings_note_id_fkey FOREIGN KEY (note_id) REFERENCES public.scholarly_notes(id) ON DELETE CASCADE;


--
-- Name: scholarly_note_translation_segments scholarly_note_translation_segments_note_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_note_translation_segments
    ADD CONSTRAINT scholarly_note_translation_segments_note_id_fkey FOREIGN KEY (note_id) REFERENCES public.scholarly_notes(id) ON DELETE CASCADE;


--
-- Name: scholarly_note_translation_segments scholarly_note_translation_segments_segment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_note_translation_segments
    ADD CONSTRAINT scholarly_note_translation_segments_segment_id_fkey FOREIGN KEY (translation_segment_id) REFERENCES public.scholarly_translation_segments(id) ON DELETE RESTRICT;


--
-- Name: scholarly_notes scholarly_notes_snapshot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_notes
    ADD CONSTRAINT scholarly_notes_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES public.scholarly_analysis_snapshots(id) ON DELETE CASCADE;


--
-- Name: scholarly_run_dependencies scholarly_run_dependencies_depends_on_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_run_dependencies
    ADD CONSTRAINT scholarly_run_dependencies_depends_on_run_id_fkey FOREIGN KEY (depends_on_run_id) REFERENCES public.scholarly_runs(id) ON DELETE RESTRICT;


--
-- Name: scholarly_run_dependencies scholarly_run_dependencies_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_run_dependencies
    ADD CONSTRAINT scholarly_run_dependencies_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.scholarly_runs(id) ON DELETE CASCADE;


--
-- Name: scholarly_runs scholarly_runs_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_runs
    ADD CONSTRAINT scholarly_runs_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.scholarly_jobs(id) ON DELETE CASCADE;


--
-- Name: scholarly_runs scholarly_runs_status_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_runs
    ADD CONSTRAINT scholarly_runs_status_code_fkey FOREIGN KEY (status_code) REFERENCES public.scholarly_job_statuses(code) ON DELETE RESTRICT;


--
-- Name: scholarly_skill_versions scholarly_skill_versions_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_skill_versions
    ADD CONSTRAINT scholarly_skill_versions_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.scholarly_skill_definitions(id) ON DELETE RESTRICT;


--
-- Name: scholarly_source_findings scholarly_source_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_source_findings
    ADD CONSTRAINT scholarly_source_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_stephanos_findings scholarly_stephanos_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_stephanos_findings
    ADD CONSTRAINT scholarly_stephanos_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_stephanos_findings scholarly_stephanos_findings_phenomenon_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_stephanos_findings
    ADD CONSTRAINT scholarly_stephanos_findings_phenomenon_fkey FOREIGN KEY (phenomenon_type_code) REFERENCES public.scholarly_stephanos_phenomenon_types(code) ON DELETE RESTRICT;


--
-- Name: scholarly_textual_findings scholarly_textual_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_textual_findings
    ADD CONSTRAINT scholarly_textual_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_translation_findings scholarly_translation_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_findings
    ADD CONSTRAINT scholarly_translation_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE CASCADE;


--
-- Name: scholarly_translation_findings scholarly_translation_findings_issue_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_findings
    ADD CONSTRAINT scholarly_translation_findings_issue_type_fkey FOREIGN KEY (issue_type_code) REFERENCES public.scholarly_translation_issue_types(code) ON DELETE RESTRICT;


--
-- Name: scholarly_translation_revision_request_findings scholarly_translation_revision_request_findings_finding_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_request_findings
    ADD CONSTRAINT scholarly_translation_revision_request_findings_finding_id_fkey FOREIGN KEY (finding_id) REFERENCES public.scholarly_findings(id) ON DELETE RESTRICT;


--
-- Name: scholarly_translation_revision_request_findings scholarly_translation_revision_request_findings_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_request_findings
    ADD CONSTRAINT scholarly_translation_revision_request_findings_request_id_fkey FOREIGN KEY (revision_request_id) REFERENCES public.scholarly_translation_revision_requests(id) ON DELETE CASCADE;


--
-- Name: scholarly_translation_revision_requests scholarly_translation_revision_requests_replacement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_requests
    ADD CONSTRAINT scholarly_translation_revision_requests_replacement_id_fkey FOREIGN KEY (replacement_translation_run_id) REFERENCES public.translation_runs(id) ON DELETE RESTRICT;


--
-- Name: scholarly_translation_revision_requests scholarly_translation_revision_requests_status_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_requests
    ADD CONSTRAINT scholarly_translation_revision_requests_status_fkey FOREIGN KEY (status_code) REFERENCES public.scholarly_revision_statuses(code) ON DELETE RESTRICT;


--
-- Name: scholarly_translation_revision_requests scholarly_translation_revision_requests_translation_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_requests
    ADD CONSTRAINT scholarly_translation_revision_requests_translation_run_id_fkey FOREIGN KEY (translation_run_id) REFERENCES public.translation_runs(id) ON DELETE RESTRICT;


--
-- Name: scholarly_translation_revision_requests scholarly_translation_revision_requests_verification_run_id_fke; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_revision_requests
    ADD CONSTRAINT scholarly_translation_revision_requests_verification_run_id_fke FOREIGN KEY (verification_run_id) REFERENCES public.scholarly_verification_runs(id) ON DELETE CASCADE;


--
-- Name: scholarly_translation_segment_source_lines scholarly_translation_segment_source_lines_segment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_segment_source_lines
    ADD CONSTRAINT scholarly_translation_segment_source_lines_segment_id_fkey FOREIGN KEY (translation_segment_id) REFERENCES public.scholarly_translation_segments(id) ON DELETE CASCADE;


--
-- Name: scholarly_translation_segments scholarly_translation_segments_snapshot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_translation_segments
    ADD CONSTRAINT scholarly_translation_segments_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES public.scholarly_analysis_snapshots(id) ON DELETE CASCADE;


--
-- Name: scholarly_verification_runs scholarly_verification_runs_scholarly_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_verification_runs
    ADD CONSTRAINT scholarly_verification_runs_scholarly_run_id_fkey FOREIGN KEY (scholarly_run_id) REFERENCES public.scholarly_runs(id) ON DELETE CASCADE;


--
-- Name: scholarly_verification_runs scholarly_verification_runs_snapshot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_verification_runs
    ADD CONSTRAINT scholarly_verification_runs_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES public.scholarly_analysis_snapshots(id) ON DELETE CASCADE;


--
-- Name: scholarly_verification_runs scholarly_verification_runs_verdict_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scholarly_verification_runs
    ADD CONSTRAINT scholarly_verification_runs_verdict_fkey FOREIGN KEY (overall_verdict_code) REFERENCES public.scholarly_verdict_types(code) ON DELETE RESTRICT;
